  ...
  .site-footer .copyright-text,.site-footer .social-icons
  {
    ...
    <div class = "container-fluid">
        ...
        <!-- echo' <img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).' -->
                ...
                <div class="card col-lg-8 col-md-8 col-sm-10" style="width: 50rem;height: 55rem; ">
                    ...
                    <!-- <form method = "post" action = "interest.php" >
                        ...
                        <button name = "interest" type = "submit" class="btn btn-outline-dark">interest &nbsp; <img src="icons-1.0.0-alpha2\icons\star.svg" width="30" height="30" class="d-inline-block align-top" alt="" ></button>
                    </form> -->
