...
<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION['username'] ?></button>
              <ul class="dropdown-menu">
                ...
                <li class="active" role="presentation" ><a href="interests.php">Interests</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <?php 
            ...
            $query="SELECT DISTINCT InstrestedAcc,title,id,date FROM interest,account,item WHERE itemid=id AND FKuser='$user' ORDER BY date DESC";
           $result=mysqli_query($con,$query);
           
           
           if(!mysqli_num_rows($result)){
            echo("<div class='alert alert-danger' role='alert'>No interests on your products found</div>");
           }
           while($row=mysqli_fetch_array($result)){
            ...
            echo '<div class="col-lg-9 col-md-9 mb-9">
                <div class="card h-100">
                  ...
                  <button type="button" class="btn btn-outline-secondary">'.$row['InstrestedAcc'].'</button>
                  <div class="card-footer"><small class="text-muted">'.$row['date'].'</small></div>
                </div>
              </div>';
          }
