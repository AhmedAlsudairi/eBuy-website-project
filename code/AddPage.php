...
$query = "INSERT INTO item(title, MDescription, FDescription, FKuser, image) VALUES ('$name','$desc','$desc','$user','$file')";
    mysqli_query($connect,$query);
    echo '<script> alert("The item was added successfully") </script>';
    mysqli_close($connect) ;
    header('Location:myProducts.php?message=Product has been added successfuly');
}
...
<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION['username'] ?></button>
          ...
          <div class="jumbotron jumbotron-fluid">
            <div class="container">
                    ...
                    <p class="lead">You can add any item you want to sell.<br>
                    </p>
            </div>
              </div>
              <div class="container">
                    ...
                    <form class="form" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="Iname">Item name :</label>
                            <input name="Iname" id = "Iname" type="text" size="30" maxlength="50" class="form-control">
                      </div>
                      <br>
                      <div class="form-group">  
                      <label for="Idesc">Item description :</label>
                        <input name="Idesc" id="Idesc" maxlength="200" class="form-control">
                      </input>
                      </div>
                      <br>
                      <div class="form-group">
                    <label for="Iimg">Add image : 
                      <input type="file" id="img" name="img" accept="image/*" class="form-control">
                      </div>
                    </label>
                    <button type="submit" name="submit" id="submit" class="btn btn-default button" value="submit"> Submit</button>
                ...
                $(document).ready(function(){  
                     $('#submit').click(function(){  
                         ...
                         var  item_img = $('#img').val() ;
                            ...
                            if(item_img == '' ||  item_name== '' || item_desc == '' )  
                                {  
